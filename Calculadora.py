...
boton_parententesis1 = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton("("))
boton_parententesis2 = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton(")"))
...
boton_parententesis1.grid(row =  1 , column = 1 , padx = 5, pady = 5)
boton_parententesis2.grid(row =  1 , column = 2 , padx = 5, pady = 5)
...
boton0.grid(row = 5 , column = 0 , columnspan = 2 , padx = 4, pady = 4)
